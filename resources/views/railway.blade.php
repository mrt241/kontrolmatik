...
<ul class="nav navbar-nav navbar-right">
                <li class="dropdown languagebtn">
                    ...
                    <li>
                            <a href="/tr/demiryolu-ve-ulasim"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.tr')}} </a>
                        </li>
                        <li>
                            <a href="/railway-and-transportation"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.eng')}} </a>
                        </li>
                        <li>
