...
<ul class="nav navbar-nav navbar-right">
                <li class="dropdown languagebtn">
                    ...
                    <li>
                            <a href="/tr/dagitim-ve-sanayi-bolgesi"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.tr')}} </a>
                        </li>
                        <li>
                            <a href="/distribution-industrial-zone"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.eng')}} </a>
                        </li>
                        <li>
