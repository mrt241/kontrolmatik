...
<ul class="nav navbar-nav navbar-right">
                <li class="dropdown languagebtn">
                    ...
                    <li>
                            <a href="/enerji-santralleri-ve-elektrik-iletim-ve-dagitimi"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.tr')}} </a>
                        </li>
                        <li>
                            <a href="/en/power-plant-and-transmission"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.eng')}} </a>
                        </li>
                        <li>
