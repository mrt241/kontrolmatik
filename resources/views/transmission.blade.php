...
<ul class="nav navbar-nav navbar-right">
                <li class="dropdown languagebtn">
                    ...
                    <li>
                            <a href="/tr/iletim-hatti-ve-trafo-merkezi"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.tr')}} </a>
                        </li>
                        <li>
                            <a href="/transmission-substation"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.eng')}} </a>
                        </li>
                        <li>
