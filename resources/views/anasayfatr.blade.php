...
<!--Video Section Ends Here-->
    ...
    <div class="col-md-4 col-xs-2 items"><a href="main-laravel/laravel/storage/app/public/brochures/May2020/mxDYX5lctIuKJ5wuiRYv.pdf" target="blank" class="pull-left" data-toggle="tooltip" data-placement="top" title=""><i class="fas fa-file-alt"></i> <div class="broname">Pano Çözümleri(TR)</div></a></div>
    <div class="col-md-4 col-xs-2 items"><a href="main-laravel/laravel/storage/app/public/brochures/May2020/jSgw6ZPgxnIoDfTicwr6.pdf" target="blank" class="pull-left" data-toggle="tooltip" data-placement="top" title=""><i class="fas fa-file-alt"></i> <div class="broname">EPCM Broşürü(TR)</div></a></div>
    <div class="col-md-4 col-xs-2 items"><a href="main-laravel/laravel/storage/app/public/brochures/May2020/DuciXncbjp76KveAIoTJ.pdf" target="blank" class="pull-left" data-toggle="tooltip" data-placement="top" title=""><i class="fas fa-file-alt"></i> <div class="broname">Elektrik ve Otomasyon(TR)</div></a></div>
                ...
                <a href="/tr/brosurler" class="btn btn-lg btn-red pull-right">Broşürler</a>
                <a href="/tr/kontrolmatik/hakkimizda" class="btn btn-lg btn-red pull-right">Daha fazla bilgi için...</a>
       </div>
        </div>
    </div>
...
<div class="hometab-title" style="background:#ee232f; color:#fff;">
    <div class="container">
        <h2 class="animated fadeInUp wow">SEKTÖRLER</h2>
 ...
 <div class="col-md-12 sectorContent">
    <div class="col-md-12 sectorblok" style="padding:0 !important;">
        ...
        <!-- item -->
            ...
            <div class="col-md-6 col-xs-12 item col-item ">
                    <div class="title">ENERJİ ÜRETİMİ</div>
                    <div class="desc">Kontrolmatik enerji üretiminde tasarım aşamasından başlayıp; tedarik, yapım ve montaj ile test ve devreye...</div>
                    <div class="readmore">Devamını Oku<i class="fas fa-arrow-right"></i></div>
            </div>
            </a>
            <!-- item end -->
        <!-- item -->
            ...
            <div class="col-md-6 col-xs-12 item col-item col-4">
                    <div class="title">Proses Endüstrisi </div>
                    <div class="desc">Şirket, proses endüstrisinde tasarım ve uygulamanın temelini oluşturan uluslararası standartlar...</div>
                    <div class="readmore">Devamını Oku <i class="fas fa-arrow-right"></i></div>
            </div>
            </a>
            <!-- item end -->
    ...
    <div class="col-md-12 sectorblok" style="padding:0 !important;">
        ...
        <!-- item -->
            ...
            <div class="col-md-6 col-xs-12 item col-item ">
                    <div class="title">Petrol ve Doğalgaz </div>
                    <div class="desc">Kontrolmatik çözüm ortakları ile petrol rafinerileri ve petrol endüstrisinde tüm elektrifikasyon...</div>
                    <div class="readmore">Devamını Oku <i class="fas fa-arrow-right"></i></div>
            </div>
            </a>
            <!-- item end -->
        <!-- item -->
            ...
            <div class="col-md-6 col-xs-12 item col-item col-4">
                    ...
                    <div class="desc">Yaklaşımımız, madeninizden pazarladığınız ürüne kadar tüm katma değerli üretim zincirini kapsar. Proje boyutundan bağımsız olarak...</div>
                    <div class="readmore">Devamını Oku <i class="fas fa-arrow-right"></i></div>
            </div>
            </a>
            <!-- item end -->
...
<div class="hometab-title">
    <div class="container">
        <h2 class="animated fadeInUp wow">ÇÖZÜMLER</h2>
    ...
    <div class="container">
        <div class="col-md-4">
            <div class="item animated wow fadeInUp">
                ...
                <div class="redbox">
                    <h3>OTOMASYON</h3>
                    <p class="short">Standart bilgisayar donanımıyla çalışabilme, DCS, PLC gibi kontrol sistemlerinin yanı sıra tüm kontrol parametrelerini görsel kontrol araçlarına dönüştürebilme özelliğiyle SCADA yazılımı, sistemi ileriye-dönük değişen gereksinimleri karşılamak üzere genişletmeyi mümkün kılar.</p>

                    <a href="/tr/cozumler/otomasyon" class="more">Devamını Oku
       ...
       <div class="col-md-6">
                <div class="item animated wow fadeInUp">
                    <div class="graybox">
                        <h3>Nesnelerin interneti ve VERİ ANALİTİĞİ</h3>
                        <p class="short">Nesnelerin İnterneti (IoT) çözümleri sizi şimdiye kadar görülmemiş bir derecede müşteriler, ticari faaliyetler ve çevreyle bir araya getirebilir. İşte IoT'nin işletmenize katabileceklerinden bazı örnekler:</p>
                        <a href="/tr/cozumler/nesnelerin-interneti-ve-veri-analitigi" class="more">Devamını Oku
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
       ...
       <div class="col-md-6">
                <div class="item animated wow fadeInUp">
                    <div class="graybox">
                        <h3>YARDIMCI SANTRAL SİSTEMLERİ</h3>
                        <p class="short">Enerji santralinizin tipinden bağımsız olarak, deneyimimiz ve mühendislik bilgimiz, tesisatlarınıza özel “Yardımcı Santral Sistemleri” entegrasyonunu ve anahtar teslim sistem entegrasyonunu sağlamamıza imkan verir</p>
                        <a href="/tr/cozumler/yardimci-santral-sistemleri" class="more">Devamını Oku
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
       ...
       <div class="col-md-12">
                <div class="item animated wow fadeInUp">
                    ...
                    <div class="redbox redboxL col-md-6">
                        <h3>ANAHTAR TESLİM ÇÖZÜMLER</h3>
                        <p class="short">Mühendislik Kontrolmatik uzun yıllar danışmanlık ve mühendislik deneyimleri olan profesyonelleri süreç, sivil, yapısal, mekanik, borulama, enstrümantasyon ve</p>
                        <a href="/tr/cozumler/anahtar-teslim-cozumler" class="more">Devamını Oku
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                </div>
    ...
    <div class="ref-content">
        ...
        <div>
              <div class="ref-item">
                  ...
                  <div class="mask"></div>
                  <div class="centered">ELEKTRİK ÜRETİMİ </div>
              </div>
          </div>
        </a>
          ...
          <a href="tr/iletim-hatti-ve-trafo-merkezi">
              ...
              <div class="ref-item">
                  ...
                  <div class="mask"></div>
                  <div class="centered">İLETİM HATTI VE TRAFO MERKEZİ</div>
              </div>
          </div>
          </a>
          <a href="tr/dagitim-ve-sanayi-bolgesi">
              ...
              <div class="ref-item">
                  ...
                  <div class="mask"></div>
                  <div class="centered">DAĞITIM VE SANAYİ BÖLGESİ</div>
              </div>
          </div>
          </a>
        ...
        <a href="tr/endustriyel-tesisler">
          <div>
              <div class="ref-item">
                  ...
                  <div class="mask"></div>
                  <div class="centered">ENDÜSTRİYEL TESİSLER </div>
              </div>
          </div>
          </a>
          ...
          <a href="tr/demiryolu-ve-ulasim">
            <div>
              <div class="ref-item">
                  ...
                  <div class="mask"></div>
                  <div class="centered">DEMİRYOLU VE ULAŞIM</div>
              </div>
          </div>
          </a>
          <a href="tr/nesnelerin-interneti-ve-siber-guvenlik">
            <div>
              <div class="ref-item">
                  ...
                  <div class="mask"></div>
                  <div class="centered">NESNELERİN İNTERNETİ VE SİBER GÜVENLİK</div>
              </div>
          </div>
          </a>
...
<div class="world-map globalmap">
        <div class="container">
            ...
            <div class="text1">200'den fazla çalışan</div>
            <div class="text2">20'den fazla ülkede çok sayıda proje yürütüldü.</div>
            </div>
            <div class="map-bg">
            ...
            <div class="pointer p12 fadeIn animated wow" data-wow-duration="1.5s" data-wow-delay="1.8s">
                <a href="tr/iletisim" class="pull-left" data-placement="top">
                <i class="fas fa-map-marker-alt"></i><div class="name"><strong>Özbekistan</strong><br> </div>
                </a>
            </div>
    ...
    <div class="homefooter-form">
        <div class="container">
            ...
            <div class="col-md-8 col-xs-12 mnopadding">
                ...
                <div class="col-md-12 clearfix mnopadding">
                        <div class="col-md-6 col-xs-12 mnopadding">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="form_name" id="form_name" placeholder="Adınız Soyadınız" required="">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="form_email" id="form_email" placeholder="E-Posta Adresiniz" required="">
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="form_phone" id="form_phone" placeholder="Telefon Numarası" required="">
                                </div>
                        ...
                        <div class="col-md-6 col-xs-12 mnopadding">
                            <div class="form-group">
                                <textarea class="form-control" rows="5" name="form_message" id="form_message" placeholder="Mesajınız" required=""></textarea>
                            </div>
                ...
                <div class="col-md-12">
                    <button class="btn btn-red" name="gonder" type="submit">Mesaj Gönder</button>
                </div>
            </div>
        </form>
    ...
    <div class="col-md-12 footerinfo">© 2019 - Tüm Hakları Saklıdır</div>
