...
<ul class="nav navbar-nav navbar-right">
                <li class="dropdown languagebtn">
                    ...
                    <li>
                            <a href="/tr/nesnelerin-interneti-ve-siber-guvenlik"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.tr')}} </a>
                        </li>
                        <li>
                            <a href="/iot-cybersecurity"><span class="flag-icon flag-icon-gb"></span>  {{Lang::get('home.eng')}} </a>
                        </li>
                        <li>
